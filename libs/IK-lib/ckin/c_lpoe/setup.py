...
setup(
    ...
    description='Utilities for LPOE based computations.',
    long_description=long_description,
    install_requires=[
        'backports.functools_lru_cache >= 1.5 ; python_version <= "2.7"',
    ],
    license='Other/Proprietary License',
    url='https://gitlab.cognibotics.net/cb/c_lpoe',
    py_modules=['lpoe_wrapper'],
    cmdclass={
        'build_py': build_py,
