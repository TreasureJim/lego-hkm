...
void motor_reset_angle() {
  ...
  rc_servo_send_pulse_normalized(
      1, joint_angle_to_libservo_value(current_joint_angles[0]));
  rc_servo_send_pulse_normalized(
      2, joint_angle_to_libservo_value(current_joint_angles[1]));
  rc_servo_send_pulse_normalized(
      3, joint_angle_to_libservo_value(current_joint_angles[2]));
  rc_servo_send_pulse_normalized(
      4, joint_angle_to_libservo_value(current_joint_angles[3]));
